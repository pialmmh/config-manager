package com.telcobright.stellar.rest.service;

import com.telcobright.stellar.rest.model.*;
...
public class EntityModificationService {
    ...
    private static final Logger LOG = Logger.getLogger(EntityModificationService.class.getName());
    ...
    private EntityHierarchy buildEntityHierarchy(EntityModificationRequest request) {
        ...
        try {
            ...
            LOG.info("Successfully built hierarchy: " + key + " with " + levels.size() + " levels");
            
        } catch (Exception e) {
            LOG.warning("Failed to build hierarchy: " + key + " - " + e.getMessage());
    ...
    private void buildLevels(EntityModificationRequest request, String parentEntity,
        ...
        EntityHierarchy.EntityLevel level = new EntityHierarchy.EntityLevel(
            entityName, tableName, primaryKey
        );
    ...
    private List<String> getTableColumns(String tableName) {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            LOG.warning("Failed to get columns for table: " + tableName);
        }
        return columns;
    }
